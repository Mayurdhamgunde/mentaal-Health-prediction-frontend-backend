...
const SocialMediaForm = ({ formData, handleChange, handleNext, handlePrevious }) => {
  return (
    <form className="space-y-4">
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-2 text-gray-800">Social Media Data</h2>
        <p className="text-gray-600 text-sm">Please provide information about your social media usage</p>
      </div>
