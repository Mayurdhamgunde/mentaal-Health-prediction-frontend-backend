...
const SpeechPatternForm = ({ formData, handleChange, handleSubmit, handlePrevious, loading }) => {
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-2 text-gray-800">Speech Pattern Data</h2>
        <p className="text-gray-600 text-sm">Please provide speech analysis metrics</p>
      </div>
